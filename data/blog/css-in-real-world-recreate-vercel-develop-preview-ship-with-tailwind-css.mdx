...
Earlier this week I [tweeted](https://twitter.com/limweijin/status/1445010823252955138) about a [Tailwind Play version](https://play.tailwindcss.com/DntnlBJk2F) of [Vercel](https://vercel.com/home) "Develop. Preview. Ship" Hero Header. Here is how it looks like on Vercel Homepage:
...
You can see the source code of [this site Hero](https://github.com/LimWeiJin/portfolio-blog/blob/master/components/Hero.tsx) to see how I implemented it. Hope you enjoyed the read.
