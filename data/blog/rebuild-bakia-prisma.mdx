...
Bakia is short for "Anyone". The product is an E-commerce website that sells custom toys. Features include:
...
- Easy migration with PlanetScale. I covered the migration workflow in [my previous post](https://www.limweijin.dev/blog/develop-a-fullstack-workflow-with-prisma-and-planetscale-in-nextjs).
